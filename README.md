...
🔗 **Live Streamlit App**: [Click here](https://heartdiseaseclassification-kgagpmdrswfccv84spu4zs.streamlit.app/)

🔗 **GitHub Repository**: [Click here](https://github.com/AchharK/Heart_Disease_Classification)
...
```bash
git clone https://github.com/AchharK/Heart_Disease_Classification
cd Heart_Disease_Classification-main {mention here the location where the folder is saved)
```
...
3. **Ensure models are trained**:
   - Run all cells in `ML_Assignment_two.ipynb`
...
└── models/                                    # Saved trained models (generated by notebook)
    ├── ML_Assignment_two.ipynb                # Jupyter notebook with model training
...
## 15. Screenshot of BITS Virtual lab


<img width="1728" height="1117" alt="Screenshot 2026-02-14 at 12 33 21 PM" src="https://github.com/user-attachments/assets/76afa3e5-c965-4149-be95-c41ab7f353e5" />
